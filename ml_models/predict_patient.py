...
if __name__ == "__main__":
    ...
    default_sex_package_dir = os.path.join(project_root, "ml_models", "gender_prediction_package")
    default_region_package_dir = os.path.join(project_root, "ml_models", "region_prediction_package")
